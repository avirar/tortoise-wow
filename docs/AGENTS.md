<!-- Canonical copy: /root/AGENTS.md — edits there, then re-sync. Synced 2026-09-19 (R7 L2 RPG walking state machine DONE + verified 10-bot soak; PlayerGrindMgr level-band cache + Rpg* state-machine files; rpgEnabled default OFF; AC 2500/500yd distances verbatim). -->
...
### R7 Walking Movement (L1) + RPG State Machine (L2) (2026-09-19)
