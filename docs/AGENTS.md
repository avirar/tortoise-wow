<!-- Canonical copy: /root/AGENTS.md — edits there, then re-sync. Synced 2026-09-20 (R7 L4/L5 quest ACTIONS + WIRING DONE + deployed + accept verified live: Inisto AI-accepted 4 level-matched quests in Darnassus; 8 RpgBaseAction quest helpers; RpgDoQuestAction; config weights AC defaults; pacing cooldown; full kill-cycle next). -->
